...
function setup()
  return {
    properties = {
      max_speed_for_map_matching      = 95/3.6, -- 180kmph -> m/s
    ...
    vehicle_width = 2.4, -- in meters, ways with narrow tag are considered narrower than 2.2m

    -- Size of the vehicle, to be limited mostly by legal restriction of the way
    vehicle_length = 7, -- in meters, 4.8m is the length of large or family car
